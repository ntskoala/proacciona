...
switch ($method) {
  case 'GET':
    $sql = "select *, ResultadosControl.id as idr from ResultadosControl INNER JOIN controles ON controles.id = ResultadosControl.idcontrol WHERE controles.idempresa=$idempresa AND ResultadosControl.fecha >= '$fechainicio' AND ResultadosControl.fecha <= '$fechafin'"; break;
}
//echo $sql;
