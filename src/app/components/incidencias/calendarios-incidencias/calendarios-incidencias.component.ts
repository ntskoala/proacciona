              ...
              if (response.success && response.data) {
                for (let element of response.data) {
                  ...
                  (element.responsable_cierre>0)? responsable_cierre = this.findSupervisor(element.responsable_cierre):responsable_cierre =  '';
                    ...
                    "periodicidad":element.periodicidad,"color":color,"valoracion":element.valoracion,"estado":element.estado,"idsupervisor":element.supervisor,
                    "responsable_ciere":responsable_cierre});
